...
import project1 from "../assets/Projects/ai-portfolio.png";
import project2 from "../assets/Projects/botbyte.png";
import {
  DiJavascript1,
  DiAngularSimple,
  DiHtml5,
...
function About() {
  return (
    <div
      data-aos="fade-up"
      className="max-w-[1000px] mb-6 md:mt-10 mx-auto p-6 grid md:grid-cols-2 gap-8 place-items-center"
      id="about"
    >
      <div className="md:p-6">
        <h2 className="text-gray-200 text-3xl font-bold mb-4">Skills</h2>
        <p data-aos="fade-up" className="text-gray-300 mb-4">
          As a passionate web front-end developer with 4 months of experience, I
          have a proven track record of creating visually stunning and
          responsive websites.
        </p>
        <div
          data-aos="fade-up"
          className="flex flex-wrap gap-2 md:gap-4 text-4xl justify-center"
        >
      ...
      <div className="relative group max-w-[600px]">
        <div
          className="w-full absolute inset-0 bg-gradient-to-r from-purple-700 to-orange-900 rounded-lg
      ...
      <div className="relative group order-2 md:order-1 max-w-[600px]">
        <div
          className="w-full h-full absolute inset-0 bg-gradient-to-r from-purple-700 to-orange-900 rounded-lg
                        blur opacity-25 group-hover:opacity-100 transition duration-300"
        ></div>
        <div className="relative p-4 bg-white bg-opacity-10 backdrop-blur-lg rounded-lg">
          <img
      ...
      <div className="md:p-6 order-1 md:order-2">
        <section id="internships" className="text-white">
          <h2 className="text-gray-200 text-3xl font-bold mb-6">
            Frontend Experience
          </h2>
          <div className="space-y-8">
            {internships.map((internship, index) => (
              <div
                data-aos="fade-up"
                key={index}
                className="border-l rounded-lg p-2"
              >
                  ...
                  <div className="mt-1">
                    {internship.techStack.split(", ").map((tech, index) => (
                      <>
                        <span
                          key={index}
                          className="text-xs md:text-sm bg-gray-700 text-white py-1 rounded-lg mr-1 inline-block"
                        >
                          {tech}
                        </span>
                      </>
