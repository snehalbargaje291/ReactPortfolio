  ...
  return (
    <div className='text-gray-200 max-w-[1200px] h-24 mx-6 px-4 md:px-0 flex justify-between items-center text-lg'>
      ...
      <ul className='hidden md:flex '>
        <li className='p-5 '><Link smooth={true} offset={50} duration={500} to="portfolio">Portfolio</Link></li>
        <li className='p-5'><Link smooth={true} offset={50} duration={500} to="about">About</Link></li>
        <li className='p-5'><Link smooth={true} offset={50} duration={500} to="contact">Contact</Link></li>
      </ul>
